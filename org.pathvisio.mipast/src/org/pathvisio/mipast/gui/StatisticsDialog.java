...
public class StatisticsDialog implements ActionListener{
	...
	StatisticsDialog(PvDesktop desktop, RegIntPlugin plugin){
	...
	public void statisticsDialog()  {
		...
		JPanel builder = new JPanel(layout);
				...
				try {
					...
					if (result.stm.getRowCount() == 0) {
						...
						lblResult.setText("<html>Rows in data (N): "
								...
								+ result.getBigR());
						StatisticsDialog.this.result = result;
						// dlg.pack();
					}
