...
import org.pathvisio.rip.util.ColumnTableModel;
...
/**
 * Second page of the {@link LoadFileWizard}, allows users to configure the column settings for each interaction file.
 * @author Stefan
 */
public class RipColumnPage extends WizardPanelDescriptor
{
    ...
    public RipColumnPage(RegIntPlugin plugin)
    {
        super(IDENTIFIER);
        this.plugin = plugin;
    }
    ...
    {
    	return RipImportPage.IDENTIFIER;
    }
...
//				updateBottomPanel(wizard.getImportInformationList().get(jList.getSelectedIndex()));
     ...
     * @param importInformation The {@link RipImportInformation} of the newly selected interaction file
     */
    ...
    public void aboutToDisplayPanel()
    {
    	...
    	for (RipImportInformation impInfo : plugin.getImportInformationList()) {
